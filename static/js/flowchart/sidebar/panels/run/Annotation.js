...
(function(){
    ...
    class AnnotationRunController {
        ...
        render(annotation) {
            ...
            // show sections for annotation in run mode
            this.showSections([
                'execution_progress_group'
            ]);

            // hide sections not relevant for annotation in run mode
            this.hideSections([
                'node_name',
                'python_file',
                'arguments_section',
            ...
            if (typeof this.sidebar.updateRunModeNodeDetails === 'function') {
                this.sidebar.updateRunModeNodeDetails({ annotation: annotation });
            }
        }
